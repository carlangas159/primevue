...
export interface TestcomponenteVueConfiguration {
    ripple?: boolean;
    inputStyle?: string;
    locale?: TestcomponenteVueLocaleOptions;
    filterMatchModeOptions?: any;
    zIndex?: TestcomponenteVueZIndexOptions;
    pt?: TestcomponenteVuePTOptions;
    unstyled?: boolean;
}

export interface TestcomponenteVueZIndexOptions {
    modal?: number;
    overlay?: number;
    menu?: number;
    tooltip?: number;
...
export interface TestcomponenteVuePTOptions {
...
export interface TestcomponenteVueLocaleAriaOptions {
    trueLabel?: string;
    falseLabel?: string;
    nullLabel?: string;
    star?: string;
...
export interface TestcomponenteVueLocaleOptions {
    startsWith?: string;
    contains?: string;
    notContains?: string;
    endsWith?: string;
    ...
    emptyMessage?: string;
    aria?: TestcomponenteVueLocaleAriaOptions;
}

export type TestcomponenteVueChangeTheme = (currentTheme: string, newTheme: string, linkElementId: string, callback?: Function) => void;

export declare function useTestcomponenteVue(): {
    config: TestcomponenteVueConfiguration;
    changeTheme: TestcomponenteVueChangeTheme;
};
